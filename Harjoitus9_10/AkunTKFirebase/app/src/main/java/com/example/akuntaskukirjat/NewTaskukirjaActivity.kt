...
class NewTaskukirjaActivity : AppCompatActivity() {
    ...
    private lateinit var mEditSivumaaraView: EditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mEditSivumaaraView = findViewById(R.id.edit_sivumaara)
        ...
        mEditPvmView.setOnClickListener {
            ...
            val datePickerDialog = DatePickerDialog(
                ...
                { _, yearOf, monthOfYear, dayOfMonth ->
                    ...
                    val dat = (dayOfMonth.toString() + "-" + (monthOfYear + 1) + "-" + yearOf)
        ...
        buttonSave.setOnClickListener {
            ...
            if (TextUtils.isEmpty(mEditNumeroView.text) || TextUtils.isEmpty(mEditNimiView.text)) {
                ...
                val word = "${mEditNumeroView.text};${mEditNimiView.text};${mEditPainosView.text};${mEditSivumaaraView.text};${mEditPvmView.text}"
